...
public class BoDe1Adapter extends RecyclerView.Adapter<RecyclerViewHolder>{
    Context mContext;
    List<BoDe> mData;
    public static String token;
    public static long idChosen;
    public static long time;
    public static StartingTest s;

    public BoDe1Adapter(Context mContext, List<BoDe> mData) {
        ...
        holder.setItemClickListener(new ItemClickListener() {
            ...
            public void onClick(final View view, int position, boolean isLongClick) {
                ...
                {   token=KetQua.token;
                    ...
                    APIService.apiService.startExam("Bearer "+KetQua.token,idChosen).enqueue(new Callback<StartingTest>() {
                        @Override
                        public void onResponse(Call<StartingTest> call, Response<StartingTest> response) {
                            Context context=view.getContext();
                            Intent intent= new Intent(context,ThiActivity.class);


                            StartingTest startingTest=response.body();
                            s=response.body();
                        ...
                        @Override
                        public void onFailure(Call<StartingTest> call, Throwable t) {
